...
gboolean             marker_prefs_get_use_equation_numbering     (void);
gdouble              makrer_prefs_get_zoom_level                 (void);
void                 marker_prefs_set_zoom_level                 (gdouble             val);
void                 marker_prefs_set_use_equation_numbering     (gboolean            state);
...
gboolean             marker_prefs_get_use_figure_caption         (void);
